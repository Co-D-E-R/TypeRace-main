...
const io = new Server(server, {
    pingTimeout: 60000,
    cors: {
        origin: process.env.HEROKU_APP_URL || process.env.FRONTEND_URL || "*", // Allow any origin in production
        methods: ["GET", "POST"],
        credentials: true
    },
    path: "/socket.io",
    transports: ['websocket', 'polling'] // Explicitly define transports for Heroku
});
